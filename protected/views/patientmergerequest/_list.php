...
<table class="grid" id="patientMergeRequestList">
    <thead>
        <tr>
            ...
            <th class="secondary">
                <?php echo $data_provider->getSort()->link('secondary_hos_num', 'Secondary<br><span class="hos_num">'.Yii::t('labels', 'hospital num').'</span>', array('class' => 'sort-link')) ?>
            </th>
            <th></th>
            <th class="primary">
                <?php echo $data_provider->getSort()->link('primary_hos_num', 'Primary<br><span class="hos_num">'.Yii::translate('labels', 'hospital num').'</span>', array('class' => 'sort-link')) ?>
            </th>
