...
<?php } else {?><?php Yii::t('labels', 'Hosp No'); ?>: <?php echo $element->event->episode->patient->hos_num?>, <?php echo Yii::t('labels', 'NHS No'); ?>: <?php echo $element->event->episode->patient->nhsnum?> <?php }?></strong></p>
